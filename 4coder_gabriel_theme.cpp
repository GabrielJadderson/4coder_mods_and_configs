...
static void
GabrielDarkMode(Application_Links *app)
{
    ...
    *table = make_color_table(app, arena);
    ...
    table->arrays[defcolor_back]                  = make_colors(arena, 0xFF27273F);
    ...
    table->arrays[defcolor_keyword]               = make_colors(arena, 0xffe71c4f);
    ...
    table->arrays[defcolor_line_numbers_back]     = make_colors(arena, 0xFF27273F);
